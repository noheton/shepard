 ...
 * {@link SemanticVocabularyProvider} shipped in the spatial plugin.
 *
 ...
 * already seeded as a `:Vocabulary` node by the V72 bootstrap migration
...
public class GeoTimeVocabularyProvider implements SemanticVocabularyProvider {
  ...
  public String vocabularyLabel() {
    return "GeoSPARQL + OWL-Time (spatial plugin)";
  }
