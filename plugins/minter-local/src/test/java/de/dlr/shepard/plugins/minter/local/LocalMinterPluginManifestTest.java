...
/**
 * KIP1h — structural and metadata smoke tests for {@link LocalMinterPluginManifest}.
 *
 ...
 */
class LocalMinterPluginManifestTest extends AbstractPluginManifestTest<LocalMinterPluginManifest> {

  @Override
  protected LocalMinterPluginManifest manifest() {
    return new LocalMinterPluginManifest();
  }

  @Test
  void id_isMinterLocal() {
    assertThat(manifest().id()).isEqualTo("minter-local");
  }
