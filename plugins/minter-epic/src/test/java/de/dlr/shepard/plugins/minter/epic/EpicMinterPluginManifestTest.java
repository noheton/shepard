 ...
 */
class EpicMinterPluginManifestTest extends AbstractPluginManifestTest<EpicMinterPluginManifest> {

  @Override
  protected EpicMinterPluginManifest manifest() {
    return new EpicMinterPluginManifest();
  }
  ...
  @Test
  void shepardCompatibility_containsForkVersion() {
