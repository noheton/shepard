...
public class DataObjectSearcherTest extends BaseTestCaseIT {
	...
	public static void setUp() {
		...
		dataObjectIO1 = given().spec(requestSpecification).body(payload1).when().post().then().statusCode(201).extract()
		...
		dataObjectIO2 = given().spec(requestSpecification).body(payload2).when().post().then().statusCode(201).extract()
				.as(DataObjectIO.class);
