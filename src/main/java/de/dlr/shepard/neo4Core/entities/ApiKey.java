...
public class ApiKey implements HasId {
	...
	public boolean equals(Object obj) {
		...
		return HasId.equalsHelper(belongsTo, other.belongsTo) && Objects.equals(createdAt, other.createdAt)
				&& Objects.equals(jws, other.jws) && Objects.equals(name, other.name) && Objects.equals(uid, other.uid);
	}
}
