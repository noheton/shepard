...
public interface CollectionSemanticAnnotationRest {
	...
	Response getAllCollectionAnnotations(long collectionId);
	...
	@ApiResponse(description = "not found", responseCode = "404")
	Response getCollectionAnnotation(long collectionId, long semanticAnnotationId);
	...
	@ApiResponse(description = "not found", responseCode = "404")
	Response createCollectionAnnotation(long collectionId,
	...
	@ApiResponse(description = "not found", responseCode = "404")
	Response deleteCollectionAnnotation(long collectionId, long semanticAnnotationId);
}
