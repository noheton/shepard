...
export interface CreateSpatialDataContainerRequest {
    spatialDataContainer: Omit<SpatialDataContainer, 'id'|'createdAt'|'createdBy'|'updatedAt'|'updatedBy'|'appId'|'revision'|'type'>;
}
...
export class SpatialDataContainerApi extends runtime.BaseAPI {
     ...
     * [v1] Create Spatial Data Container
     */
     ...
     * [v1] Delete Spatial Data Container
     */
    ...
    /**
     * Edit permissions
     * [v1] Edit Spatial Data Permissions
     */
     ...
     * [v1] Get Spatial Data Containers
     */
    ...
    /**
     * Get permissions
     * [v1] Get Spatial Data Permissions
     */
