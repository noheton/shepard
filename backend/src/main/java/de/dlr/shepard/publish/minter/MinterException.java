 ...
 * credential expired, malformed prefix). The {@code LocalMinter}
 * in {@code shepard-plugin-minter-local} never throws this — but
 * the contract is part of the SPI from day one so KIP1c (ePIC) and
 * KIP1d (DataCite) plug in without widening the interface.
 *
