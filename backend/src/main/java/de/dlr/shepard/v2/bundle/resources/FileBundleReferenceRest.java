...
public class FileBundleReferenceRest {
  ...
  public Response deleteGroup(
    @PathParam("bundleAppId") String bundleAppId,
    @PathParam("groupAppId") String groupAppId,
    @Parameter(description = "When true, permanently deletes all files in the group from storage before removing the group. Without this flag the call returns 400 if the group has attached files.")
  ...
  public Response listGroupFiles(
    @PathParam("bundleAppId") String bundleAppId,
    @PathParam("groupAppId") String groupAppId,
    @Parameter(description = "0-based page index. Default 0. Values past the last page return an empty items[] with correct totalElements/totalPages.")
    @QueryParam("page") Integer page,
    @Parameter(description = "Page size. Default 200; min 1; max 1000. Values outside range are clamped.")
