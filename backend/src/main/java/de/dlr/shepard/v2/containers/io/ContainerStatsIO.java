 ...
 * {@code GET /v2/containers/{appId}/stats} for container kinds that expose a
 * stats surface (today: {@code timeseries}).
 *
...
public record ContainerStatsIO(
  ...
  @Schema(description = "Number of distinct channels.", required = true)
  long channelCount,
