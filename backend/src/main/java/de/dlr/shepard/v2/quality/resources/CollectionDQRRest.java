...
public class CollectionDQRRest {
  ...
  public Response list(
    ...
    @Parameter(description = "Zero-based page index for pagination. Effective only when pageSize > 0. Omit to return all DQRs.")
    @QueryParam("page") Integer page,
    @Parameter(description = "Page size for pagination (1–200). Omit to return all DQRs.")
