...
/**
 * DI1 — safe-delete for a StructuredDataContainer (refuses to orphan active references).
 *
 * <p>Route:
 * <ul>
 *   <li>{@code DELETE /v2/structured-data-containers/{containerAppId}} — safe
 *       delete; 409 unless {@code ?force=true} when the container has active
 *       references.</li>
 * </ul>
 *
...
@RequestScoped
@Tag(name = "Structured data container safe delete")
