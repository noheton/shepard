...
public class OntologyGitSourceRest {
  ...
  public Response list(@Context SecurityContext securityContext) {
    ...
    List<OntologyGitSourceIO> result = new ArrayList<>(sources.size());
    for (OntologyGitSource s : sources) result.add(OntologyGitSourceIO.from(s));
