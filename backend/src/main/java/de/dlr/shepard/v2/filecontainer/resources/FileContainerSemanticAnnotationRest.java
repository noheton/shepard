...
/** SA-CONT — semantic annotations on a FileContainer itself. */
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
@Path("/v2/file-containers/{containerId}/annotations")
@RequestScoped
@Tag(name = "File container annotations (SA-CONT)")
public class FileContainerSemanticAnnotationRest extends SemanticAnnotationRest {

  @Inject
  FileContainerService containerService;

  @GET
  @Operation(
    operationId = "getAllFileContainerAnnotations",
    description = "List semantic annotations attached to this FileContainer."
  )
  @APIResponse(
    responseCode = "200",
  ...
  @POST
  @Operation(
    operationId = "createFileContainerAnnotation",
    description = "Attach a new semantic annotation to this FileContainer."
  )
  @APIResponse(
    responseCode = "201",
  ...
  @Path("{annotationId}")
  @Operation(
    operationId = "deleteFileContainerAnnotation",
    description = "Remove a semantic annotation from this FileContainer."
  )
  ...
  public Response deleteAnnotation(
    ...
    FileContainer container = containerService.getContainer(containerId);
    containerService.assertIsAllowedToEditContainer(containerId);
