...
public class Version implements HasId {
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(createdAt, other.createdAt) && HasId.equalsHelper(createdBy, other.createdBy)
				&& Objects.equals(description, other.description) && Objects.equals(uid, other.uid)
				&& HasId.equalsHelper(predecessor, other.predecessor) && Objects.equals(name, other.name);
	}
