...
public final class InfluxUtil {
   ...
   */
  public static InfluxTimeseriesPayload extractPayload(QueryResult queryResult, InfluxTimeseries timeseries) {
    ...
    return new InfluxTimeseriesPayload(timeseries, influxPoints);
  }
   ...
   */
  public static BatchPoints createBatch(
    String database,
    InfluxTimeseriesPayload timeseriesPayload,
    String expectedType
  ) {
    String error = "";
   ...
   */
  public static String sanitize(InfluxTimeseries timeseries) {
