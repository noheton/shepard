...
public class Timeseries implements Annotatable, HasId {
  ...
  @Relationship(type = Constants.IS_IN_CONTAINER, direction = Relationship.Direction.OUTGOING)
  @NotBlank
  private final TimeseriesContainer container;

  @Relationship(type = Constants.HAS_ANNOTATION, direction = Relationship.Direction.OUTGOING)
  @NotBlank
  private final List<SemanticAnnotation> annotations = new ArrayList<>();

  @Override
  public String getUniqueId() {
    return String.valueOf(getTimeseriesId());
  }
