...
//
// Idempotency:
//   The reconciliation query runs only when duplicates actually exist (WHERE guard).
...
//   Or let the MigrationsRunner pick it up automatically on next shepard startup.
