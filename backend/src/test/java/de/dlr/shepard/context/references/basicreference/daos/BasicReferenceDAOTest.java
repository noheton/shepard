...
public class BasicReferenceDAOTest extends BaseTestCase {
  ...
  public void findByDataObjectWithShepardQueryParamsTest_WithoutName() {
    ...
    String query =
      "MATCH (d:DataObject)-[hr:has_reference]->(br:BasicReference { deleted: FALSE }) WHERE d.shepardId=11 WITH br MATCH path=(br)-[*0..1]-(n) WHERE n.deleted = FALSE OR n.deleted IS NULL RETURN br, nodes(path), relationships(path)";
    when(session.query(BasicReference.class, query, paramsMap)).thenReturn(List.of(ref, ref3, ref4));
  ...
  public void findByDataObjectWithShepardQueryParamsTest_WithName() {
    ...
    paramsMap.put("name", "Yes");
    String query =
      "MATCH (d:DataObject)-[hr:has_reference]->(br:BasicReference { name : $name, deleted: FALSE }) WHERE d.shepardId=11 WITH br MATCH path=(br)-[*0..1]-(n) WHERE n.deleted = FALSE OR n.deleted IS NULL RETURN br, nodes(path), relationships(path)";
  ...
  public void findByDataObjectWithShepardQueryParamsTest_WithNameOrderByNameDesc() {
    ...
    paramsMap.put("name", "Yes");
    String query =
      "MATCH (d:DataObject)-[hr:has_reference]->(br:BasicReference { name : $name, deleted: FALSE }) WHERE d.shepardId=11 WITH br ORDER BY toLower(br.name) DESC MATCH path=(br)-[*0..1]-(n) WHERE n.deleted = FALSE OR n.deleted IS NULL RETURN br, nodes(path), relationships(path)";
    when(session.query(BasicReference.class, query, paramsMap)).thenReturn(List.of(ref, ref3, ref4, ref5));
  ...
  public void findByDataObjectWithShepardQueryParamsTest_WithPage() {
    ...
    paramsMap.put("name", null);
    String query =
      "MATCH (d:DataObject)-[hr:has_reference]->(br:BasicReference { deleted: FALSE }) WHERE d.shepardId=11 WITH br SKIP $offset LIMIT $size MATCH path=(br)-[*0..1]-(n) WHERE n.deleted = FALSE OR n.deleted IS NULL RETURN br, nodes(path), relationships(path)";
    when(session.query(BasicReference.class, query, paramsMap)).thenReturn(List.of(ref, ref3, ref4));
  ...
  public void findByDataObjectWithShepardQueryParamsTest_WithPageOrderByNameDesc() {
    ...
    paramsMap.put("name", null);
    String query =
      "MATCH (d:DataObject)-[hr:has_reference]->(br:BasicReference { deleted: FALSE }) WHERE d.shepardId=11 WITH br ORDER BY toLower(br.name) DESC SKIP $offset LIMIT $size MATCH path=(br)-[*0..1]-(n) WHERE n.deleted = FALSE OR n.deleted IS NULL RETURN br, nodes(path), relationships(path)";
    when(session.query(BasicReference.class, query, paramsMap)).thenReturn(List.of(ref, ref3, ref4));
  ...
  public void findByDataObjectWithShepardQueryParamsTest_WithNameAndPage() {
    ...
    paramsMap.put("name", "Yes");
    String query =
      "MATCH (d:DataObject)-[hr:has_reference]->(br:BasicReference { name : $name, deleted: FALSE }) WHERE d.shepardId=11 WITH br SKIP $offset LIMIT $size MATCH path=(br)-[*0..1]-(n) WHERE n.deleted = FALSE OR n.deleted IS NULL RETURN br, nodes(path), relationships(path)";
    when(session.query(BasicReference.class, query, paramsMap)).thenReturn(List.of(ref, ref3, ref4, ref5));
  ...
  public void findByDataObjectWithShepardQueryParamsTest_WithNameAndPageOrderByNameDesc() {
    ...
    paramsMap.put("name", "Yes");
    String query =
      "MATCH (d:DataObject)-[hr:has_reference]->(br:BasicReference { name : $name, deleted: FALSE }) WHERE d.shepardId=11 WITH br ORDER BY toLower(br.name) DESC SKIP $offset LIMIT $size MATCH path=(br)-[*0..1]-(n) WHERE n.deleted = FALSE OR n.deleted IS NULL RETURN br, nodes(path), relationships(path)";
    when(session.query(BasicReference.class, query, paramsMap)).thenReturn(List.of(ref, ref3, ref4, ref5));
