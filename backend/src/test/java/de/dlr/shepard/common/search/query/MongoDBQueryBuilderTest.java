...
public class MongoDBQueryBuilderTest {
  ...
  public void queryTest(String input, String expected) {
    String mongoDBQuery = MongoDBQueryBuilder.getMongoDBQueryString(input);
  ...
  public void queryTest_invalidJson() {
    String input = "}";
    assertThrows(ShepardParserException.class, () -> MongoDBQueryBuilder.getMongoDBQueryString(input));
  }
