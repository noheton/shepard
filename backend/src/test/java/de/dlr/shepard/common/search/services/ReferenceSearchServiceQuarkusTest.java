...
public class ReferenceSearchServiceQuarkusTest {
  ...
  public void setUp() {
    ...
    if (tsCon == null) {
      ...
      System.out.println("tsCon.id: " + tsCon.getId());
      ...
      System.out.println("te1.id: " + timeseriesEntity1.getId());
      System.out.println("te2.id: " + timeseriesEntity2.getId());
  ...
  public void containerSearch() {
    ...
    for (int i = 0; i < results.length; i++) System.out.println("results[" + i + "]: " + results[i]);
    ResultTriple[] resultSet = response.getResultSet();
    System.out.println("resultSet.length: " + resultSet.length);
    for (int i = 0; i < resultSet.length; i++) System.out.println("resultSet[" + i + "]: " + resultSet[i]);
    System.out.println("test1 now finished");*/
  }
