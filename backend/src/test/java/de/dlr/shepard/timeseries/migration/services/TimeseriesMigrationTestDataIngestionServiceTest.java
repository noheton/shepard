...
public class TimeseriesMigrationTestDataIngestionServiceTest {
  ...
  public void ingestData_ingestBooleanValues_success() {
    ...
    // act
    dataIngestionService.ingestTestData(databaseName, 5000, userName, DataPointValueType.Boolean);
  ...
  public void ingestData_ingestStringValues_success() {
    ...
    // act
    dataIngestionService.ingestTestData(databaseName, 5000, userName, DataPointValueType.String);
  ...
  public void ingestData_ingestDoubleValues_success() {
    ...
    // act
    dataIngestionService.ingestTestData(databaseName, 5000, userName, DataPointValueType.Double);
