...
public class PermissionsIT extends BaseTestCaseIT {
  ...
  public void updatePermissions_NonOwnerGetsManagerPermissions_success() {
    ...
    var actual = given()
      ...
      .body(permissions)
      .when()
      .put("/%s/%d/%s".formatted(Constants.COLLECTIONS, collection3.getId(), Constants.PERMISSIONS))
      .then()
      .statusCode(200)
      .extract()
      .as(PermissionsIO.class);
  ...
  public void permittedGetViaPublicReadable() {
    ...
    permissionsURL = "/%s/%d/%s".formatted(Constants.COLLECTIONS, collection1.getId(), Constants.PERMISSIONS);
  ...
  public void permittedGetViaReadersList() {
    ...
    permissionsURL = "/%s/%d/%s".formatted(Constants.COLLECTIONS, collection2.getId(), Constants.PERMISSIONS);
