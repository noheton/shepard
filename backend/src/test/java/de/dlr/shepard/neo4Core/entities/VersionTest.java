...
public class VersionTest extends BaseTestCase {
	...
	public void equalsContract() {
		EqualsVerifier.simple().forClass(Version.class).withPrefabValues(User.class, new User("bob"), new User("claus"))
				.withPrefabValues(Version.class, new Version(new UUID(1L, 2L)), new Version(new UUID(2L, 3L)))
				.withPrefabValues(UUID.class, new UUID(1L, 2L), new UUID(2L, 3L)).verify();
	}
