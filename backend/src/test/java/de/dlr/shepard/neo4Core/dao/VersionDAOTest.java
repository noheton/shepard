...
public class VersionDAOTest extends BaseTestCase {
	...
	public void findByCollectionIdVersionUIDTest() {
		...
		String query = "MATCH (col:Collection)-[]->(ver:Version) WHERE col.shepardId = " + collectionId
	...
	public void findHEADVersionUUIDTest() {
		...
		ver.setUid(uid);
		long collectionId = 5L;
		String query = "MATCH (c:Collection)-[:has_version]->(v:Version) WHERE c.shepardId = " + collectionId
