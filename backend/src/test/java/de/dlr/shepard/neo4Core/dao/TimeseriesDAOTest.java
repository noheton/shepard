...
public class TimeseriesDAOTest extends BaseTestCase {
	...
	public void findTest() {
		...
		when(session.query(Timeseries.class, query, Map.of("measurement", "meas", "device", "dev", "location", "loc",
				"symbolicName", "symName", "field", "value"))).thenReturn(List.of(ts));
	...
	public void findTest_notFound() {
		...
		when(session.query(Timeseries.class, query, Map.of("measurement", "meas", "device", "dev", "location", "loc",
				"symbolicName", "symName", "field", "value"))).thenReturn(Collections.emptyList());
		var actual = dao.find("meas", "dev", "loc", "symName", "value");
		assertNull(actual);
	}
