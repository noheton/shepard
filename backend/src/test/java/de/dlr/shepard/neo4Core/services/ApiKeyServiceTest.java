...
public class ApiKeyServiceTest extends BaseTestCase {
	...
	public void createApiKeyTest() {
		...
		var jws = Jwts.builder().setSubject("bob").setIssuer("uri").setNotBefore(date).setIssuedAt(date)
				.setId(uid.toString()).signWith(key).compact();
