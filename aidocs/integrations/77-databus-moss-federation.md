...
- `aidocs/integrations/67-unhide-publish-plugin.md` — Helmholtz KG channel (complementary)
- `aidocs/integrations/72-invenio-publishing-plugin.md` — InvenioRDM archival channel (complementary)
- `aidocs/integrations/66-hmc-kip-integration.md` — KIP DOI minting (links into MOSS entries)
- `aidocs/ops/58-ui-and-graph-ergonomics.md §REF1` — Databus rich references (consuming side)
- `aidocs/workflows/55-provenance-and-activity-overhaul.md` — PROV-O graph that MOSS entries summarise
- `aidocs/platform/47-dev-experience-and-plugin-system.md` — plugin SPI that MB1a follows
