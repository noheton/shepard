...
| CP1b | `GET /v2/collections/{appId}/properties` (read) + `PATCH /v2/collections/{appId}/properties` (write, owner-only) — surfaces `:CollectionProperties` via `/v2/` shelf | user request, `aidocs/58 §5` | S-M | queued | gated on CP1a (shipped). |
