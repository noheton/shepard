...
| AAS1-well-known | `GET /v2/aas/.well-known/aas-server` self-description (zero-discovery option) — emits supported profile, endpoint paths, Shell count, supported submodel templates | user request 2026-05-12, `aidocs/52 §4a.5` | S | **design done** | Recommended bundled with AAS1-reg for the v1 release. |
