...
| U3-coupled | `editor.preferredJupyter` setting — added with the lab-journal-Jupyter feature (`aidocs/37`, design pending). | — | XS | gated on aidocs/37 | Trivial setting; lands when the feature lands. |
