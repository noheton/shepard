...
`aidocs/72-invenio-publishing-plugin.md`. Summary:
...
- `aidocs/45-gridfs-to-s3-evaluation.md` — S3 storage design
- `aidocs/63-architecture-decision-log.md` — key architecture decisions
- `aidocs/70-competitor-landscape-and-feature-ideas.md` — competitive positioning
- `aidocs/72-invenio-publishing-plugin.md` — InvenioRDM plugin full design (answers §9)
