...
R2 series, A1f, A4 cache), `aidocs/28-paradigms-and-clients-synthesis.md` §3
Surface D (SSE), `aidocs/29-p10-implementation-design.md` §6 (the
"fall-through to async" gap this doc closes), and
`aidocs/31-rocrate-export-optimisation.md` (the optimisations that pair with
...
- `aidocs/24-permission-system-review.md` — admin role, principal
  identity model.
- `aidocs/25-l2-migration-phases.md` — Phase 2 backfill as a job.
- `aidocs/28-paradigms-and-clients-synthesis.md` §3 Surface D — SSE as
  the natural progress channel.
- `aidocs/29-p10-implementation-design.md` §6 — fall-through-to-async,
  the gap this doc closes.
- `aidocs/31-rocrate-export-optimisation.md` — O2 / O3 / O8 / O10, the
