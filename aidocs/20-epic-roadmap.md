...
Companion to `aidocs/11-implementation-plan.md` (phased delivery) and
...
- Bulk-close the spatial cluster per `aidocs/09-ready-to-close.md`.
...
- `aidocs/02-cluster-map.md` — Cluster E (→ E14), F (→ E11), C
  (→ E9), D (→ E6 + E14), B (→ E12 frontend test foundation).
- `aidocs/03-issues-status.md` and `aidocs/08-first-issues.md` —
  small items; #717 / #721 / #720 land inside E1 / E5 / E12.
- `aidocs/11-implementation-plan.md` — phased plan; phases 3–4
