...
Couples to: `aidocs/ops/33-frontend-workflow-analysis.md` (frontend
baseline — Nuxt 3 / Vue 3 / Vuetify 3), `aidocs/42-vision.md`
(casual-user north star + primitives), `aidocs/semantics/43-ai-opportunities.md`
(AI / LLM features sibling), `aidocs/platform/47-dev-experience-and-plugin-system.md`
(plugin SPI for the DBpedia reference), `aidocs/semantics/48-internal-semantic-repository-via-neosemantics.md`
...
`aidocs/ops/49-in-app-user-docs.md` and `aidocs/platform/51-instance-admin-role.md`
(style reference).
...
- `aidocs/semantics/13-search-improvements.md` — UI3 mention search reuses
...
- `aidocs/16-dispatcher-backlog.md` — UI1 / UI2 / UI3 / D1 / ONT1 /
  ...
  not from this PR).
- `aidocs/platform/24-permission-system-review.md` — UI1 cross-Collection
  move permission semantics; GR1 similarity-search
  permission-filtering via P2 `filterAllowedForUser`.
- `aidocs/platform/25-neo4j-id-migration-design.md` — L2d gate on UI1 /
  UI2 / UI3 / D1 / REF1 / GR1 (`appId`-native `/v2/` shelf).
- `aidocs/ops/33-frontend-workflow-analysis.md` — UI1 sidebar
...
- `aidocs/34-upstream-upgrade-path.md` — every series above adds
  ...
  reconciles).
- `aidocs/workflows/36-user-profile-and-settings-design.md` — UI2b graph-
  layout persistence lands on the `/v2/users/me/preferences/`
  surface.
- `aidocs/workflows/39-templates-design.md` and `aidocs/54` templates — D1
  properties node references `:ShepardTemplate`.
- `aidocs/data/41-snapshots-design.md` V2 — UI3c orphan-handling
...
- `aidocs/semantics/43-ai-opportunities.md` — GR1 is the retrieval layer
...
- `aidocs/platform/47-dev-experience-and-plugin-system.md` — REF1 builds
