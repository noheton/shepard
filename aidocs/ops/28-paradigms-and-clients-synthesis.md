...
`aidocs/platform/23-api-critique.md` §4 and the client-generation review in
...
**Companion docs.** `aidocs/semantics/13-search-improvements.md` (the
...
`aidocs/platform/20-epic-roadmap.md` (the two-track frame the rollout maps
into), `aidocs/platform/23-api-critique.md` §4 / §5 / §6 / §7,
`aidocs/platform/26-crud-consistency.md` (the inconsistencies the synthesis
must fix, not paint over), `aidocs/ops/27-convenience-clients-design.md`
...
- RFC 7807 `application/problem+json` per `aidocs/16 H4 / P18`
  ...
  `ApiError.java:1-11`.
- Pagination: existing `?page&size` per `aidocs/archive/18-pagination-inventory.md`
...
(security finding C4 in `aidocs/archive/01-repo-overview.md:75`) stay as
...
Reusing the `aidocs/platform/20-epic-roadmap.md` two-track frame. Each item
...
- `aidocs/semantics/13-search-improvements.md` — unified `POST /search/v2`
...
- `aidocs/archive/18-pagination-inventory.md` — pagination conventions
  (38 endpoints, four conventions; the `?page&size` rollout
  + cursor on `/search/v2`).
- `aidocs/platform/20-epic-roadmap.md` — two-track framing (Foundations vs
  User-value); E1, E2, E5, E11, E12.
- `aidocs/platform/23-api-critique.md` — §4 (per-slice paradigms, adopted
...
- `aidocs/platform/26-crud-consistency.md` — the inconsistencies the
  synthesis fixes via P21 / F1 / H4 / P9.
- `aidocs/ops/27-convenience-clients-design.md` — wrapper as
