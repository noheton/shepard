...
- `aidocs/71-fork-adoption-as-upstream.md` — cost-benefit numbers (§5–6); adoption shapes (§2)
- `aidocs/73-dlr-stakeholder.md` — DLR-wide brief; institute fit matrix
- `aidocs/74-dlr-bt-stakeholder.md` — BT pilot proposal; success metrics
- `aidocs/72-invenio-publishing-plugin.md` — InvenioRDM plugin (WP3 core deliverable)
- `aidocs/67-unhide-publish-plugin.md` — Helmholtz KG publishing (sustainability anchor)
- `aidocs/70-competitor-landscape-and-feature-ideas.md §7–8` — RDA alignment (Umfeldanalyse evidence)
