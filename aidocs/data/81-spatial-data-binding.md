...
- `aidocs/data/79-cpacs-annotator.md` — CPACS Annotator (CPACS→geometry binding for MDO
  provenance)
- `aidocs/integrations/80-rce-integration.md` — RCE Integration (RCE component execution → DataObject
