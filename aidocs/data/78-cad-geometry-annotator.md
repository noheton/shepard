...
`aidocs/data/79-cpacs-annotator.md` (CPACS-specific annotator built on this foundation).
...
- `aidocs/platform/47-dev-experience-and-plugin-system.md` — PayloadKind / PayloadStorage SPI (plugin
