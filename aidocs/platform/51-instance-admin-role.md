...
`aidocs/archive/07-security-issues.md` C3; `aidocs/ops/22-admin-cli-draft.md`
§4.6 / §4.11; `aidocs/platform/24-permission-system-review.md` F-series;
`aidocs/workflows/36-user-profile-and-settings-design.md` (profile UI
