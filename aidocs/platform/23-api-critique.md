...
- Search endpoints use `page` + `size` on `/search/containers`
  ...
  The full inventory is in `aidocs/archive/18-pagination-inventory.md` —
...
Already inventoried — see `aidocs/archive/18-pagination-inventory.md`.
...
(security finding C4 — see `aidocs/archive/01-repo-overview.md:75`). For
...
- Backlog: `aidocs/16-dispatcher-backlog.md` (A2, P3, P4, P4b,
  L6, A4d, H4).
- Pagination inventory: `aidocs/archive/18-pagination-inventory.md` (38
  endpoints).
