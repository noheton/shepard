...
- `aidocs/strategy/74-dlr-bt-stakeholder.md` — DLR-BT institute brief; ADAPT project mentioned
- `aidocs/strategy/75-dfg-eresearch-funding.md` — DFG funding sketch; Bedarfsnachweis section
