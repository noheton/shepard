...
| **2022-05** | `aasDetailsPart1V3Rc02_2022` — *Details of the Asset Administration Shell Part 1: The exchange of information between partners in the value chain of Industrie 4.0 (Version 3.0RC02)* (Plattform Industrie 4.0 / IDTA; published May 2022; produced Nov 2020 – May 2022) | Plattform Industrie 4.0 / IDTA sub-working-group on AAS (~50 contributors); **FK** named contributor (DLR e.V., confirmed p. 229 of PDF) | The normative AAS metamodel specification V3.0RC02. Defines: AAS metamodel (submodels, submodel elements, semantic identifiers), AASX exchange-package format, access control (ABAC), exchange-format mappings (XML/JSON/OPC UA/AutomationML/RDF). Krebs's named participation in the Plattform I4.0 standards body is **peer evidence that Shepard's architect sat inside the I4.0 process for the AAS substrate Shepard is later positioned beneath** — per `zlpDataDrivenIntelligence2025` slide 23, `weberAerospaceX2025`, and `krebsDIVA2026`. Extends the RDF/OWL AAS survey at `aasRdf2019`. Superseded as normative release by IDTA-01001-3-0 (January 2023); V3.0RC02 is the version carrying Krebs's name. | AAS Semantic Shell / RDF+OWL representation (`aasRdf2019`) | `krebsDIVA2026` (AAS Typ 3 as active application protocol); `weberAerospaceX2025` (AAS as digital-twin tech base); `shepard-plugin-aas` design (planned) | No standalone library doc yet — candidate for `aidocs/integrations/` AAS integration design |
