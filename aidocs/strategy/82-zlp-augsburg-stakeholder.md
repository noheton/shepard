...
- `aidocs/strategy/74-dlr-bt-stakeholder.md` — DLR-BT stakeholder brief (comparison institute)
- `aidocs/strategy/75-dfg-eresearch-funding.md` — DFG e-Research-Technologien application sketch
- `aidocs/strategy/76-shepard-users-and-citations.md` — Known users and citations (ZLP publications catalogue)
- `aidocs/data/78-cad-geometry-annotator.md` — 3D Geometry and FEM Annotator design
- `aidocs/data/79-cpacs-annotator.md` — CPACS Annotator design
- `aidocs/integrations/80-rce-integration.md` — RCE Integration design
- `aidocs/81` — Spatial Data Binding design (forthcoming)
- `aidocs/strategy/73-dlr-stakeholder.md` — DLR-wide stakeholder brief
