...
- `aidocs/semantics/43-ai-opportunities.md` — AI layer design
...
- `aidocs/data/50-experiment-orchestration.md` — experiment entity design
- `aidocs/integrations/67-unhide-publish-plugin.md` — publication integration
- `aidocs/integrations/72-invenio-publishing-plugin.md` — InvenioRDM submission plugin (new)
