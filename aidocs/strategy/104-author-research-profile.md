...
|---|---|---|---|---|
| 2003–2008 | **Diplominformatiker, Universität Augsburg** — *"Entwicklung eines Systems zur Implementierung von Layered Module Architekturen"* (Development of a System for Implementing Layered Module Architectures). Supervised by **Dr. Martin E. Müller**, Lehrstuhl für Multimedia-Konzepte und Anwendungen. Submitted **24 May 2008** (titlepage.tex timestamp). Matrikelnummer 784661. *Primary-source detail verified 2026-05-26 from `backup-projects/Diplomarbeit/` zip on UNAS NAS.* **PARIA project:** the thesis implements and evaluates a Brooks-subsumption-inspired layered agent architecture for multi-robot WiFi coordination — LEGO RCX robots + WiPort WiFi bridge + brickOS + Java TCP server. Complementary / adjacent work: **Sandra Jobst** (2007 Masterarbeit *"Eine Plattform zur Realisierung von Multiagentensystemen mit mobilen Robotern"*, Universität Augsburg [@jobstMasterarbeit2007]). **Deep-prior signal for the thesis:** the same modular/layered design philosophy — behavior as composable, independently testable subsystems with clean inter-layer contracts — resurfaces 18 years later in Shepard's plugin SPI (`shepard-plugin-*`, `aidocs/platform/47`) and the A3b feature-toggle registry. | (degree) | — | — |
| 2008 | *Relational Cognitive Structures for Intelligent Agent and Robot Control* — IEEE SMC 2008, DOI 10.1109/ICSMC.2008.4811781. **Directly derived from the PARIA / Diplom-thesis work; earliest peer-reviewed Krebs publication on ORCID; predates DLR employment by ~1 year; the deep-prior ontology signal arising from the Diplom-thesis era.** | co-author | (TBD — author list pending PDF verification) | [@krebsSmcRelationalCognitive2008] |
