...
| **Singleton `FileReference` (single-file primitive, FR1b)** + `/v2/files/...` shelf + V16b opt-in carve-out migration | n/a | design done | 📐 (queued, FR1b — depends on FR1a) | `aidocs/53 §1.8` |
