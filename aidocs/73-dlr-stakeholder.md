...
- `aidocs/74-dlr-bt-stakeholder.md` — BT-specific brief (pilot candidate)
- `aidocs/71-fork-adoption-as-upstream.md` — full adoption feasibility and cost-benefit
- `aidocs/42-vision.md` — researcher-facing vision
- `aidocs/72-invenio-publishing-plugin.md` — InvenioRDM submission plugin
- `aidocs/67-unhide-publish-plugin.md` — Helmholtz KG publishing
- `aidocs/66-hmc-kip-integration.md` — KIP DOI minting
