...
|---|---|---|
| **Collection** | A campaign, project, or topic — the top-level grouping. Collections marked with `urn:shepard:project = true` appear in the **Projects** top-nav page (`/projects`), which bundles related sub-collections under a single entry point with optional programme filtering. | "LUMEN-Inspired Hot-Fire Test Campaign — Q3 2024" |
