...
`aidocs/23-api-critique.md` after §2.10 catalogued the 14-line
...
`validUntil`, E7 HDF5), `aidocs/23-api-critique.md` §5.6,
...
- `aidocs/23-api-critique.md` §5.6 (motivation) and §2.10
  (boilerplate cost).
- `aidocs/13-search-improvements.md` — once unified search
