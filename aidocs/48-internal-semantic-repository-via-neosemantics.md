...
| **N1c** | `shepard-admin semantic refresh-ontologies` CLI (per `aidocs/22 §4.x`). Validates SHA, re-imports, reports diff. | S | N1a + `aidocs/22` |
...
- **aidocs:** `aidocs/14-semantic-improvements.md` (the broader
