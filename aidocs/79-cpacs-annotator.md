...
- `aidocs/78-cad-annotator.md` — 3D Geometry & FEM Annotator (shepard-plugin-cad);
  ...
  CPACS1c–d reuse
- `aidocs/80-rce-integration.md` — RCE workflow integration (CPACS provenance chain in §7
  requires RCE1b)
- `aidocs/47-dev-experience-and-plugin-system.md` — PayloadKind / PayloadStorage SPI that
