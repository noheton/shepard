...
- `aidocs/66-hmc-kip-integration.md` — KIP PID minting (DOI coordination)
- `aidocs/67-unhide-publish-plugin.md` — parallel plugin shape (reference implementation)
- `aidocs/31-rocrate-export-optimisation.md` — RO-Crate export (the file we attach)
- `aidocs/47-dev-experience-and-plugin-system.md` — plugin SPI reference
- `aidocs/71-fork-adoption-as-upstream.md §9` — originating open question
