...
- `aidocs/73-dlr-stakeholder.md` — DLR-wide brief (institute-fit matrix, cost-benefit)
- `aidocs/42-vision.md` — researcher-facing vision
- `aidocs/72-invenio-publishing-plugin.md` — InvenioRDM publication path
- `aidocs/50-experiment-orchestration.md` — experiment campaign orchestration
