...
| [Sustainability]({{ '/admin/sustainability/' | relative_url }}) | Energy and CO₂ disclosure for operators filling DMP sustainability sections (EU Horizon Europe, Clean Aviation JU, Helmholtz). Honest-numbers methodology, no-greenwash posture, copy-paste DMP language. |
