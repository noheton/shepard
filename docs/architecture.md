...
hero_lede: Stack, persistence, entity model, auth, and export — sourced from `aidocs/archive/01-repo-overview.md` and the in-repo `architecture/src/` AsciiDoc.
hero_bg: green
audience: [user, admin, plugin-author]
---
This page summarises shepard's architecture as it exists today. Sources:
`aidocs/archive/01-repo-overview.md`, `architecture/src/05_building_block_view/`,
