...
. We use two tables to persist the data, timeseries table and timeseries_data_points.
...
. We use a seperate column for each type of data in the timeseries_data_points table
