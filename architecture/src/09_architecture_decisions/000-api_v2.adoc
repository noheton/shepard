...
[CAUTION]
====
26.08.2024: With changes implemented in link:https://gitlab.com/dlr-shepard/shepard/-/merge_requests/233[this MR], some of the endpoints definitions went through minor changes.
====
...
image::api_v2/class_diagram.png[]
