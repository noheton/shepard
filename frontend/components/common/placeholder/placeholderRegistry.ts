...
export const PLACEHOLDER_ENTRIES: PlaceholderEntry[] = [
  ...
  // TS-SEMANTIC-REST
  {
    ...
    subtitle:
      "Semantic annotations on individual timeseries channels. Channels receive identity annotations automatically via the TS-SEMANTIC-01 dual-write. Additional annotations can be added via POST /v2/timeseries-containers/{containerAppId}/channels/{channelShepardId}/annotations.",
    endpoint: "/v2/timeseries-containers/{containerAppId}/channels/{channelShepardId}/annotations",
