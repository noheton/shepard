 ...
 *
 * Calls PATCH /v2/bundles/{appId} with { name: newName } on save.
 * Only `name` is patchable at the bundle level; group-level metadata
 * is edited via PATCH /v2/bundles/{bundleAppId}/groups/{groupAppId}.
 *
 * Emits:
