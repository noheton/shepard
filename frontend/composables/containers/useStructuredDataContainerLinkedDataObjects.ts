 ...
 *
 * Calls GET /v2/structured-data-containers/{containerAppId}/linked-data-objects.
...
export function useStructuredDataContainerLinkedDataObjects(containerAppId: string | Ref<string | null>) {
  ...
  async function fetchLinkedDataObjects() {
    ...
    try {
      const url = `${v2BaseUrl()}/v2/structured-data-containers/${encodeURIComponent(id)}/linked-data-objects`;
