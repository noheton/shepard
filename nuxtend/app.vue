  ...
  <NuxtLayout>
    <v-app>
      ...
      <v-toolbar color="primary" dark>
        <v-toolbar-title>Vuetify App Example</v-toolbar-title>
        <v-btn icon>
        ...
        <v-row>
          <v-col cols="12" md="6">
            <v-card class="mx-auto my-5" elevation="4">
              ...
              <v-card-text>
                Explore some of the most beautiful places in the world. Sit
                back, relax, and take in the beauty of nature.
              </v-card-text>
            ...
            <v-card class="mx-auto my-5" elevation="4">
              ...
              <v-card-text>
                <v-form>
                  ...
                  <v-textarea label="Message" rows="4" outlined></v-textarea>
                </v-form>
              </v-card-text>
