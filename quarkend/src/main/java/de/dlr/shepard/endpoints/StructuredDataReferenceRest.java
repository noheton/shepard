...
public interface StructuredDataReferenceRest {
  ...
  @ApiResponse(
    description = "ok",
    responseCode = "200",
    content = @Content(array = @ArraySchema(schema = @Schema(implementation = StructuredDataReferenceIO.class)))
  )
  ...
  @ApiResponse(
    description = "ok",
    responseCode = "200",
    content = @Content(array = @ArraySchema(schema = @Schema(implementation = StructuredDataPayload.class)))
  )
  @ApiResponse(description = "not found", responseCode = "404")
